...
**Статус**: 🔄 В работе — проверяются последние коммиты, ветки и deploy-настройки Union, затем будет восстановлена правильная версия и добавлена защита от повторного deploy из `main`.
