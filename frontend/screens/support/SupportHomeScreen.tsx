...
const defaultConfig: SupportConfig = {
    ...
    channelUrl: '',
    slaTextRu: 'AI отвечает сразу, оператор в рабочее время отвечает в течение 4 часов.',
...
const supportHomeCopy = {
    ru: {
        ...
        subtitle: 'Технические проблемы, помощь с навигацией по продукту и обратная связь.',
        moderationTitle: 'МОДЕРАЦИЯ UGC',
        moderationText: 'Для жалоб на контент или пользователей используйте «Создать тикет». Поддержка ведется в чате, без email.',
        slaTitle: 'SLA',
        loading: 'Загружаем каналы поддержки…',
        openTelegram: 'Открыть поддержку в Telegram',
        createTicket: 'Создать тикет без Telegram',
