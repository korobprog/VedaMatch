    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                <Text style={styles.questionCounter}>{t('education.questionInfo', { current: currentIndex + 1, total: questions.length })}</Text>

                <View style={styles.questionCard}>
                    <Text style={styles.questionText}>{currentQuestion?.text}</Text>
                    {currentQuestion?.verse_reference && (
                        <Text style={styles.verseRef}>{t('education.source')}: {currentQuestion.verse_reference}</Text>
                    )}
                </View>
