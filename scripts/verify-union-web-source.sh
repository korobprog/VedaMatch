...
require_text "packages/i18n/src/index.ts" "publicTitle: \"Осознанные знакомства без лишнего шума\""
...
forbid_text "packages/i18n/src/index.ts" "Осознанные знакомства в благости"
