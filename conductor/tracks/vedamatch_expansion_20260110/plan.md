...
- [ ] Задача: Реализовать логику "Тегов" для интересов и навыков.
    - [ ] Подзадача: Таблицы `tags`, `user_tags`.
    - [ ] Подзадача: API для поиска и добавления тегов.
...
- [ ] Задача: Обновить эндпоинт поиска (`searchUsers`) для поддержки режима `mode`.
    - [ ] Подзадача: Фильтр для Бизнеса (по навыкам).
    - [ ] Подзадача: Фильтр для Семьи (существующий + доработки).
    - [ ] Подзадача: Фильтр для Служения/Интересов.
