...
- [ ] **Task 1: Проектирование и миграция БД**
...
- [ ] **Task 2: Базовый API CRUD для новостей и источников**
...
- [ ] **Task: Conductor - User Manual Verification 'Phase 1: База данных и Базовая структура API' (Protocol in workflow.md)**

## Phase 2: Система парсинга (Backend - Go/Python)
- [ ] **Task 1: Реализация универсального интерфейса парсера**
    - Создать структуру для расширяемых парсеров.
- [ ] **Task 2: Парсеры для RSS и прямых ссылок**
    - Реализовать извлечение контента из RSS-лент и HTML-страниц (мета-теги, OpenGraph).
- [ ] **Task 3: Интеграция с ВК и Telegram**
    - Реализовать получение постов из публичных групп ВК и ТГ-каналов.
- [ ] **Task 4: Фоновый планировщик задач**
