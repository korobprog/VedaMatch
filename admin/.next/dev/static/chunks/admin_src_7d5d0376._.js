...
"[project]/admin/src/app/admins/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminsPage() {
    ...
    const handleAddAdmin = async (e)=>{
        ...
        setSuccess(false);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/admin/admins', {
                email,
                password,
                role
            });
...
_s(AdminsPage, "b9q7lXJ8CDQF9rXAb4l/PxRGlEs=", false, function() {
    return [
...
//# sourceMappingURL=admin_src_7d5d0376._.js.map