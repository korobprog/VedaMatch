...
const features = [
  { icon: ShoppingBag, color: 'from-orange-400 to-red-500', delay: 0 },
  { icon: Heart, color: 'from-pink-400 to-rose-500', delay: 0.1 },
  { icon: MessageCircle, color: 'from-blue-400 to-indigo-500', delay: 0.2 },
  { icon: Coffee, color: 'from-amber-500 to-orange-600', delay: 0.3 },
  { icon: BookOpen, color: 'from-amber-400 to-yellow-500', delay: 0.4 },
  { icon: GraduationCap, color: 'from-cyan-400 to-blue-500', delay: 0.5 },
  { icon: HandHelping, color: 'from-emerald-500 to-teal-600', delay: 0.6 },
  { icon: Newspaper, color: 'from-emerald-400 to-green-500', delay: 0.7 },
  { icon: Compass, color: 'from-red-400 to-orange-500', delay: 0.8 },
  { icon: MapPin, color: 'from-lime-400 to-emerald-500', delay: 0.9 },
  { icon: Megaphone, color: 'from-orange-300 to-amber-500', delay: 1.0 },
  { icon: Sparkles, color: 'from-purple-400 to-violet-500', delay: 1.1 },
];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-20">
          ...
          >
            ...
            <span className="text-orange-600 italic">{copy.features.titleLine2}</span>
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, idx) => {
            ...
            const item = copy.features.items[idx];
            return (
              <motion.div
                key={idx}
              ...
              >
                ...
                <p className="text-[#5c4d47] leading-relaxed text-sm opacity-80">{item.description}</p>
              </motion.div>
            );
          })}
        </div>
