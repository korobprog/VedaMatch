...
export function PhilosophySection({ copy }: { copy: LandingCopy }) {
  return (
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-serif mb-8 leading-tight">
              {copy.philosophy.titleLine1} <br />
              <span className="text-orange-400 italic">{copy.philosophy.titleLine2}</span>
            </h2>
            <p className="text-xl text-white/70 mb-10 leading-relaxed font-light">{copy.philosophy.description}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {pillars.map((pillar, idx) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold">{copy.philosophy.pillars[idx].title}</h3>
                  <p className="text-white/50 text-sm leading-relaxed">{copy.philosophy.pillars[idx].text}</p>
                </motion.div>
              ))}
            </div>
          </motion.div>
          ...
          >
            <div className="relative z-10 rounded-[3rem] overflow-hidden shadow-2xl border border-white/10">
              <img src="/krishna_bg.png" alt="Mission Illustration" className="w-full h-auto object-cover opacity-80" />
              ...
              <div className="absolute bottom-8 left-8 right-8 bg-white/10 backdrop-blur-xl p-6 rounded-2xl border border-white/20">
                <p className="text-white italic text-lg leading-relaxed">{copy.philosophy.quote}</p>
              </div>
            </div>
          </motion.div>
        </div>
