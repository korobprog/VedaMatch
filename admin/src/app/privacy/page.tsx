  ...
  return (
    <main className="mx-auto max-w-4xl px-4 py-10 text-[var(--foreground)]">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-semibold">7. Модерация и обработка жалоб</h2>
        <p>
          Для расследования жалоб на контент и пользователей мы можем обрабатывать текст обращения,
          вложения (например, скриншоты), идентификаторы участников, метаданные контента и технические логи сессий.
        </p>
        <p>
          Модерационные данные хранятся в объеме, необходимом для рассмотрения обращения, предотвращения повторных
          нарушений и исполнения требований закона. Базовый срок хранения модерационных логов — до 365 дней, если
          более длительный срок не требуется законом.
        </p>
        <p>
          Контакты по модерации и поддержке:{' '}
          <a className="underline" href="mailto:support@vedamatch.ru">support@vedamatch.ru</a>. По вопросам
          приватности:{' '}
          <a className="underline" href="mailto:privacy@vedamatch.ru">privacy@vedamatch.ru</a>.
        </p>
      </section>
